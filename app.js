...
/* ---------- 导航 ---------- */
const MODULE_TITLES = { fitness: "运动健身", nutrition: "饮食营养", dashboard: "数据看板", resources: "外部资源库", goals: "目标与提醒", trackers: "上次记录", english: "英语学习", pantry: "食物入库", watermark: "图片去水印", backup: "备份同步", reading: "英语精读", readingex: "阅读文章" };
...
function restoreData(obj) {
  ...
  // 仅恢复已知字段，避免脏数据
  const keys = ["profile", "exercises", "foods", "weights", "resources", "goals", "reminds", "checkins", "trackers", "english", "pantry", "fitLinks", "posturePlan", "antiMenu", "word1800", "overtime", "reading"];
